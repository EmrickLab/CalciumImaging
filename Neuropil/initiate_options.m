options_np = struct('expansion_size',15,...                 %how much to expand in search for neuropil signal
                    'exclusion_size',5,...                  %how many pixels exclude at the border
                    'exclusion_percentage',0.15,...         %how much of high level neuropil pixels exclude
                    'pause_after_graphing',0,...
                    'frames_per_acq',200,...
